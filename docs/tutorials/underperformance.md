...
**Time:** ~10 minutes
**Skills used:** `coaching-mode` → `performance-management` → `feedback-frameworks` (all people pack)
...
**Prerequisites:** haku installed — see [the install guide](../install.md) — plus the people pack (`scripts/install.sh --pack people`).
...
- [Build a promotion case](promo-case.md) — the other end of the performance spectrum
