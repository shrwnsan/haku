...
> **Pack note:** `wins-log` is core and always installed. The two supporting skills here—`wins-due` and `wins-curate`—ship in the **people pack** (`scripts/install.sh --pack people`). See [Packs](../packs.md).
