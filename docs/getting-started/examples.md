...
If you'd logged reflections on this engineer, the Observation would arrive already cited with dates—that's the [memory system](../reference/file-locations.md) paying off.
...
Ready to generate your own? [Install](../install.md), then run `/haku:start`.
