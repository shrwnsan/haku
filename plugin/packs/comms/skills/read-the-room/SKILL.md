...
2. **Who was in the room.** Names, roles, the user's relationship to each. If any are registered in `~/haku-work-reflections/`, *read those files* — past reflections are your context.
