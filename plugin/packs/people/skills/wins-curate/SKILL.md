...
4. For perf-review mode, also read `~/haku-work-reflections/self/reflections.md` (if it exists) and any registered stakeholders' files (via `stakeholders.json`) — composition.
